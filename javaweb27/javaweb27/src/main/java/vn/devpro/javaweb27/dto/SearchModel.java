...
public class SearchModel {
		...
		private int totalPade;//Tổng số trang
		...
		public SearchModel(int status, int categoryId, String keyword, String beginDate, String endDate, int sizeOfPage,
				int currentPage, int totalItems, int totalPade) {
			super();
			this.status = status;
		...
		public int getTotalPade() {
			return totalPade;
		}

		public void setTotalPade(int totalPade) {
			this.totalPade = totalPade;
		}
